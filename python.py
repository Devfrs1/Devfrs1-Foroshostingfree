...
def send_auth_prompt(chat_id):
    meta = load_metadata()
    shared_url = meta.get("shared_url") or meta.get("app_url") or os.environ.get("APP_URL") or "https://ais-pre-ibfvs6szu3tx5qhs5dfim7-544632747714.asia-east1.run.app"
    if "ais-dev-" in shared_url:
        shared_url = shared_url.replace("ais-dev-", "ais-pre-")
